...
export function ModeFiveSingleView({ session }: SessionDetailsProps) {
    ...
    <Box sx={{ my: 2 }}>
      ...
      <Box sx={{ my: 2 }}>
        ...
        <Box display="flex" justifyContent="flex-end" sx={{ mr: 3 }}>
          <Button variant="contained" startIcon={<GridOnIcon />} onClick={() => handleGenerateExcelModeFive(session)} sx={{ mr: 1 }}>
            Download EXCEL
          </Button>
