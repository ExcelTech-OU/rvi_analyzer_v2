...
import { ModeFiveDto, ModeSixDto, ModeThreeDto, useShareReportMutation } from '../../services/sessions_service';
import { CircularProgress, Grid, IconButton, Link, Typography } from '@mui/material';
import ContentCopyIcon from '@mui/icons-material/ContentCopy';

type ModeSixShareAlertDialogProps = {
    session: ModeSixDto;
    open: boolean;
    changeOpenStatus: (status: boolean) => void;
}

export default function ModeSixShareAlertDialog({ open, session, changeOpenStatus }: ModeSixShareAlertDialogProps) {
    ...
    function share() {
        ...
        shareReport({ modeId: "6", sessionId: session.defaultConfigurations.sessionId })
            .unwrap()
            .then((payload) => {
