...
//        return Mono.just(userRepository.findByUsername(jwtUtils.getUsername(jwt)))
...
//                .flatMap(device -> Mono.just(userRepository.findByUsername(jwtUtils.getUsername(jwt)))
//                        .flatMap(user -> {
