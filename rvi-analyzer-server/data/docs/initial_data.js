...
db.role.insertMany([
  ...
  {
    "role-id": "get_mode_seven_current_range",
    "role-name": "GET_MODE_SEVEN_CURRENT_RANGE",
  },
  {
    "role-id": "set_mode_seven_current_range",
    "role-name": "SET_MODE_SEVEN_CURRENT_RANGE",
  },
]);
...
db.groupRole.insertMany([
  {
    ...
    "role-ids": [
      ...
      "allocate_customer",
      "get_devices",
      "get_mode_seven_current_range",
      "set_mode_seven_current_range",
    ],
  },
  {
    "group-id": "admin_group",
