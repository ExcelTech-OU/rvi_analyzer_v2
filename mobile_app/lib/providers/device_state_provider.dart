...
class DeviceState extends ChangeNotifier {
  ...
  void updateSelectedModeId(int id) {
    selectedModeId = id;
    notifyListeners();
  }
  ...
  TextEditingController poNumberControllerMode7 = TextEditingController();
  TextEditingController currentReadingMacControllerMode07 =
      TextEditingController();
  TextEditingController currentReadingCurrentControllerMode07 =
      TextEditingController();
  TextEditingController currentReadingVoltageControllerMode07 =
      TextEditingController();
