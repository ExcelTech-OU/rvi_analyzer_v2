...
type ModeSixPdfDocumentProps = {
    session: ModeSixDto;
}

// Create Document Component
function ModeSixPdfDocument({ session }: ModeSixPdfDocumentProps) {
    return (
        <Document>
            <Page size="A4" style={styles.page}>
                <View style={styles.section}>
                    ...
                    <View>
                        ...
                        <Text style={styles.sessionTextPrefix}>Fixed Current   : <Text style={styles.sessionText}>{session.sessionConfigurationModeSix.fixedCurrent}</Text> </Text>
                        <Text style={styles.sessionTextPrefix}>Max Voltage   : <Text style={styles.sessionText}>{session.sessionConfigurationModeSix.maxVoltage}</Text> </Text>
                        <Text style={styles.sessionTextPrefix}>Time Duration  : <Text style={styles.sessionText}>{session.sessionConfigurationModeSix.timeDuration}</Text> </Text>
                    </View>
...
export default ModeSixPdfDocument;