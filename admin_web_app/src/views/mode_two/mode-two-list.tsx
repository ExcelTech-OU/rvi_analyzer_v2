...
import { ModeTwoDto, useGetModeTwoSessionsQuery } from "../../services/sessions_service";
                                                                    ...
                                                                    .map((item, index) => {
                                                                        return (
                                                                            <StyledTableRow hover role="checkbox" tabIndex={-1} >
                                                                                ...
                                                                                <StyledTableCell align={'left'}>
                                                                                    {item.sessionConfigurationModeTwo.current}
                                                                                </StyledTableCell>
                                                                                <StyledTableCell align={'left'}>
                                                                                    {item.sessionConfigurationModeTwo.maxVoltage}
                                                                                </StyledTableCell>
                                                                                <StyledTableCell align={'left'}>
                                                                                    {item.sessionConfigurationModeTwo.passMinVoltage}
                                                                                </StyledTableCell>
                                                                                <StyledTableCell align={'left'}>
                                                                                    {item.sessionConfigurationModeTwo.passMaxVoltage}
                                                                                </StyledTableCell>
                                                                                <StyledTableCell align={'right'}>
                                                                                    <CustomizedMenusModeTwo session={item as ModeTwoDto} />
                                                                                </StyledTableCell>
                                                                            </StyledTableRow>
                                                                        );
                                                                    })}
