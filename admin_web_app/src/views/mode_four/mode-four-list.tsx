...
export default function ModeFourList() {
    ...
    var { data, error, isLoading } = useGetModeFourSessionsQuery({ data: { date: date, filterType: filterType, filterValue: filterValue }, page: page })
                                                                    ...
                                                                    .map((item, index) => {
                                                                        return (
                                                                            <StyledTableRow hover role="checkbox" tabIndex={-1} >
                                                                                ...
                                                                                <StyledTableCell align={'left'}>
                                                                                    {item.sessionConfigurationModeFour.startingCurrent}
                                                                                </StyledTableCell>
                                                                                <StyledTableCell align={'left'}>
                                                                                    {item.sessionConfigurationModeFour.desiredCurrent}
                                                                                </StyledTableCell>
                                                                                <StyledTableCell align={'left'}>
                                                                                    {item.sessionConfigurationModeFour.maxVoltage}
                                                                                </StyledTableCell>
                                                                                <StyledTableCell align={'left'}>
                                                                                    {item.sessionConfigurationModeFour.currentResolution}
                                                                                </StyledTableCell>
                                                                                <StyledTableCell align={'left'}>
                                                                                    {item.sessionConfigurationModeFour.chargeInTime}
                                                                                </StyledTableCell>
                                                                                <StyledTableCell align={'right'}>
                                                                                    <CustomizedMenusModeFour session={item as ModeFourDto} />
                                                                                </StyledTableCell>
                                                                            </StyledTableRow>
                                                                        );
                                                                    })}
