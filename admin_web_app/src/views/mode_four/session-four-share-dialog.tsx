...
import { ModeFourDto, ModeThreeDto, useShareReportMutation } from '../../services/sessions_service';
import { CircularProgress, Grid, IconButton, Link, Typography } from '@mui/material';
import ContentCopyIcon from '@mui/icons-material/ContentCopy';

type ModeFourShareAlertDialogProps = {
    session: ModeFourDto;
    open: boolean;
    changeOpenStatus: (status: boolean) => void;
}

export default function ModeFourShareAlertDialog({ open, session, changeOpenStatus }: ModeFourShareAlertDialogProps) {
    ...
    function share() {
        ...
        shareReport({ modeId: "4", sessionId: session.defaultConfigurations.sessionId })
            .unwrap()
            .then((payload) => {
