...
import { ModeThreeDto, useShareReportMutation } from '../../services/sessions_service';
import { CircularProgress, Grid, IconButton, Link, Typography } from '@mui/material';
import ContentCopyIcon from '@mui/icons-material/ContentCopy';

type ModeThreeShareAlertDialogProps = {
    session: ModeThreeDto;
    open: boolean;
    changeOpenStatus: (status: boolean) => void;
}

export default function ModeThreeShareAlertDialog({ open, session, changeOpenStatus }: ModeThreeShareAlertDialogProps) {
